...
if ( ! function_exists( 'oraiste_core_add_standard_mobile_header_options' ) ) {
	/**
	 ...
	 */
	function oraiste_core_add_standard_mobile_header_options( $page, $general_tab ) {
	...
	add_action( 'oraiste_core_action_after_mobile_header_options_map', 'oraiste_core_add_standard_mobile_header_options', 10, 2 );
}
