...
if ( ! function_exists( 'oraiste_core_add_elegant_icons_to_collection' ) ) {
	/**
	 ...
	 * @return array
	 */
	function oraiste_core_add_elegant_icons_to_collection( $icons ) {
		$icons[] = 'OraisteCore_Elegant_Icons_Pack';

		return $icons;
	}

	add_filter( 'qode_framework_filter_add_icon', 'oraiste_core_add_elegant_icons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class OraisteCore_Elegant_Icons_Pack extends QodeFrameworkIconPack {
