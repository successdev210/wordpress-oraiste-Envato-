...
if ( ! function_exists( 'oraiste_core_add_minimal_header_meta' ) ) {
	/**
	 * Function that add additional header layout meta box options
	 *
	 * @param object $page
	 */
	function oraiste_core_add_minimal_header_meta( $page ) {
	...
	add_action( 'oraiste_core_action_after_page_header_meta_map', 'oraiste_core_add_minimal_header_meta' );
}
