...
if ( ! function_exists( 'oraiste_core_add_h2_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 *
	 * @param object $page
	 */
	function oraiste_core_add_h2_typography_options( $page ) {
		...
		if ( $page ) {
			$h2_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-h2',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'H2 Typography', 'oraiste-core' ),
					'description' => esc_html__( 'Set values for Heading 2 HTML element', 'oraiste-core' ),
				)
			);
	...
	add_action( 'oraiste_core_action_after_typography_options_map', 'oraiste_core_add_h2_typography_options' );
}
